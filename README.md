...
| inputsContainerClassName | string                                         | undefined       | Yes          | Define the className to change the styles used in the inputs container                                                                  |
| colonClassName           | string                                         | undefined       | Yes          | Define the className to change the styles used in the colon separator (:)                                                               |
